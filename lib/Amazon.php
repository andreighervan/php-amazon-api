  ...
  public function __construct($access_key, $secret_key, $associate_tag)
  {
    ...
    $this->common_params = [
      ...
      'Operation' => 'ItemSearch',
        "ResponseGroup" => "Accessories,AlternateVersions,BrowseNodes,EditorialReview,Images,ItemAttributes,ItemIds,Large,Medium,OfferFull,OfferListings,Offers,OfferSummary,PromotionSummary,Reviews,SalesRank,SearchBins,Similarities,Small,Tracks,Variations,VariationMatrix,VariationOffers,VariationSummary",
        'ItemPage'=>10,
